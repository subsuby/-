		...
		<section>
			<div class="autoPop">
				...
				<div class="btnAreaType">
					<span><button id="btnAddrCancel" onclick="return false;" class="line p-close">취소</button></span>
					<span><button id="btnAddrSelect" onclick="return false;" >확인</button></span>
				</div>
			</div>
		</section>
	</div>
...
<div class="popupAutoWrap popGroup p-container w670">
	<!-- popup header -->
	<div class="popupHeaderAuto" id="groupPopup">
		...
		<section>
			<div class="autoPop">
				<div class="searchArea">
					...
					<input type="hidden" id="selectGroupNo" name="selectGroupNo" value="">
					<input type="hidden" id="selectGroupName" name="selectGroupName" value="">
					<input type="text" id="searchGroupName" name="searchGroupName" value="">
						<button type="button" id="btnGroupSearch" class="iconSearch"><span>검색</span></button>
				</div>
				<div class="popList">
					<ul id="dataGroupList">
					</ul>
				...
				<div class="btnAreaType">
					<span><button id="groupCancel" onclick="return false;" class="line p-close">취소</button></span>
					<span><button id="groupSuccess" onclick="return false;">확인</button></span>
				</div>
			</div>
		</section>
	</div>
...
<!-- 2017-08-03 종사자번호 변경 -->
<div class="popupAutoWrap pwChange2 p-container w670">
	<!-- popup header -->
	<div class="popupHeaderAuto">
		<header><h1>종사자번호 변경</h1></header>
		<a class="btnClose p-close" onclick="return false;"><em class="blind">닫기</em></a>
	</div>
	<hr/>
	<!-- popup contents -->
	...
	<div class="popupContents">
			<div class="changeInfo">
				<p class="pwPractician">새로운 종사자번호를 입력하여 주세요.<br /> 사용하시던 종사자번호는 삭제처리 됩니다.</p>
				<div class="pwForm">
					<form method="post" action="">
						<fieldset>
							<input type="text" id="oldDealerLicenseNo" value="" class="mb10" placeholder="현재 종사자번호를 입력하세요." />
							<input type="text" id="newDealerLicenseNo" value="" placeholder="새로운 종사자번호를 입력하세요." />
							<input type="text" id="newDealerLicenseNoChk" value="" placeholder="다시한번 종사자번호를 입력하세요." />
							<div class="btnSet btn_pwreset">
								<span><button id="btnDealerCancel" onclick="return false;" class="redLine p-close">취소</button></span>
								<span><button id="btnDealerUpdate" onclick="return false;" class="red">종사자번호 변경</button></span>
							</div>
						</fieldset>
					</form>
				</div>
