...
import com.bnk.plus.commons.paginator.Paginator;
...
//		}
	...
	public void setPaginateHtml(String paginateHtml) {
		Paginator paginator = new Paginator("", curPage, totBlockSize);
		this.paginateHtml = paginator.toString();
	}
