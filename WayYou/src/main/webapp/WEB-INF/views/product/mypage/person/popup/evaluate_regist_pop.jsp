        ...
        <section>
            <div class="autoPop">
                <div class="ratingArea">
                    <span>
                        <label for="ch1"><input type="checkbox" name="popEvalDiv[]" id="ch1" value="1" checked/> 상담</label>
                        <label for="ch2"><input type="checkbox" name="popEvalDiv[]" id="ch2" value="2"/> 거래</label>
                    </span>
                    <span>
                        <strong>별점</strong>
