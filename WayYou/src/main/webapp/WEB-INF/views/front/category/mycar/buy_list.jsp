			...
			<ul class="listType1 grid2 btn-toggle-switch-target">
				<li ng-repeat="car in carList">
					...
					<div class="prBack">
						...
						<span class="heartSet">
							<input ng-if="sessUserInfo.division == -1" type="checkbox" id="h_1{{$index}}" ng-checked="car.dibsYn === 'Y'" ng-click="onClick('DIBS_ON',car)" onclick="return false;"/>
							...
							<label for="h_1{{$index}}"><!--찜하기--></label></span>
					</div>
				</li>
			</ul>
