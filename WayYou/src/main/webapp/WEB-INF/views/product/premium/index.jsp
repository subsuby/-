	...
	<aside class="leftMenu">
		...
		<div class="btn-accordion-wrapper writeType" data-toggle-on="true">
			...
			<dl class="btn-accordion-switch accordionSet">
				...
				<dd class="accordionData">
					<div class="overflowCase"> <!-- 2017-08-22 by mj-cho -->
						<ul id="makeList" class="dotList">
			...
			<dl id="detailModelDl" class="btn-accordion-switch accordionSet">
				...
				<dd class="accordionData">
					<div class="overflowCase"> <!-- 2017-08-22 by mj-cho -->
						<ul id="detailModelList" class="dotList">
						</ul>
					</div>
				</dd>
			</dl>
			...
			<dl class="btn-accordion-switch accordionSet">
				...
				<dd class="accordionData">
					<div class="overflowCase"> <!-- 2017-08-22 by mj-cho -->
						<ul class="dotList" id="areaList" >
							<c:forEach var="areaInfo" items="${areaList}" varStatus="status">
								<li><input type="checkbox" id="SEARCH_WORD_AREA_${status.count}" onclick="onToggle(this, {id:'SEARCH_WORD_AREA',code:'${status.count}',name:'${areaInfo.cdDtlNm}'})" /> <label for="SEARCH_WORD_AREA_${status.count}">${areaInfo.cdDtlNm}</label></li>
							</c:forEach>
						</ul>
					</div>
				</dd>
