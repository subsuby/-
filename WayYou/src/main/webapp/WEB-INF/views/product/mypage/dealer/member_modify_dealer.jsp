			...
			<div class="loginLayout bgGrayCase pt80">
				<div class="joinForm formArea">
					...
					<div class="writeRow btnType">
						...
						<button type="button" class="wAuto btn-popup-auto" id="btnPwdPop" onclick="return false;" data-pop-opts='{"target": ".pwChange"}'>비밀번호 변경</button> <!-- 2017-07-19 -->
					</div>
					...
					<div class="writeRow btnType">
						...
						<button type="button" class="btn-popup-auto" id="btnAddrPop" onclick="return false;" data-pop-opts='{"target": ".findAddress"}'>변경</button> <!-- 2017-07-19 -->
					</div>
					<div class="writeRow">
					...
					<div class="writeRow btnType">
						<input type="hidden"  id="danjiNo" name="danjiNo" value="${userInfo.danjiNo}">
						<input type="text" id="dealerDanjiName" name="dealerDanjiName" value="${userInfo.dealerDanjiName}" placeholder="소속단지" readonly="readonly">
						<label for="" class="dn">소속단지</label>
						<button type="button" class="btn-popup-auto" id="btnGroup" onclick="return false;" data-pop-opts='{"target": ".popGroup"}'>검색</button> <!-- 2017-07-19 -->
					</div>
					<div class="writeRow btnType">
						<input type="hidden"  id="shopNo" name="shopNo" value="${userInfo.shopNo}">
						<input type="text"  id="dealerShopName" name="dealerShopName" value="${userInfo.dealerShopName}" placeholder="소속상사" readonly="readonly">
					   	<label for="" class="dn">소속상사</label>
					   	<button type="button"class="btn-popup-auto" id="btnShop" onclick="return false;" data-pop-opts='{"target": ".popGroup"}'>검색</button> <!-- 2017-07-19 -->
					</div>
					<div class="writeRow">
					   	<input type="text" id="shopEtc" name="shopEtc" value="${userInfo.shopEtc}" placeholder="기타소속">
					   	<label for="shopEtc" class="dn">기타소속</label>
					</div>
					<div class="writeRow btnType lastRow mb20">
						<input type="text" id="dealerLicenseNo" name="dealerLicenseNo" value="${userInfo.dealerLicenseNo}" placeholder="종사자번호" readonly>
						<label for="" class="dn">종사자번호</label>
						<button type="button" class="btn-popup-auto" id="btnLicense" onclick="return false;" data-pop-opts='{"target": ".pwChange2"}'>변경</button> <!-- 2017-07-19 -->
					</div>
                    ...
                    <div class="btnSet">
                        <span><a href='<c:url value="/product/mypage/mycarDealer"/>' id="btnUseUpdateCacel" class="redLine">취소</a></span>
