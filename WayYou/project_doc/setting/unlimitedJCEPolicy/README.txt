...
-----------------------------------------------------------------------------------------------------------
개발환경 구축 및 서버환경 구축시 꼭 해야한다.

아래 proejct경로에 있는 local_policy.jar, US_export_policy.jar 파일을 아래 jre 경로에 붙여넣는다.
(* 암호화시 128bit키로밖에 생성이 안되서 256bit키를 사용하기위해서)
 
   Project: project_doc/setting/unlimitedJCEPolicy/UnlimitedJCEPolicyJDK7/UnlimitedJCEPolicy/local_policy.jar
   jre: C:\Program Files\Java\jdk1.7.0_51\jre\lib\security
