		...
		<div class="form">
			...
			<div class="loginLayout bgGrayCase pt80">
				<form id="frm" name="frm" method="POST" action="">
					...
					<input type="hidden" id="urlType" name="urlType" value="01" >
					<div class="joinForm formArea">
	                    ...
	                    <div class="writeRow btnType phoneNum lastRow mb20">
	                        ...
	                        <span>
	                            <input type="number" value="" id="phoneNo" name="phoneNo" maxlength="11" oninput="maxLengthCheck(this)" placeholder="전화번호">
