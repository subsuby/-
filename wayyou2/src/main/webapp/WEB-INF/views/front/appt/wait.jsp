...
<section>
	<div class="searchArea" id="apptTitle">
		<h3 class="menuTitle"><spring:message code="wait.wait_appt"/></h3>
		<input type="button" value="<spring:message code='wait.search'/>" class="btn btn-search btn-outline" onclick="WaitScript.search()">
		<input type="text" placeholder="<spring:message code='wait.search'/>" class="searchBox">
		<input type="text" id="datePicker" class="datePicker searchBox" placeholder="<spring:message code='wait.date'/>" readonly/>
		<input type="button" value="<spring:message code='wait.reset'/>" class="btn btn-reset btn-outline" onclick="WaitScript.reset()">
	</div>
					...
					<div class="panel-group">
						<div class="panel schedule-item" style="margin-top:7%;">
							...
							<h6 class="title blueColor" style="font-size:15px;width: 80%;display: inline-block">
								<spring:message code="wait.msg.there_are_no_appt"/>
								<br/><spring:message code="wait.msg.lets_regist_appt"/>
							</h6>
						</div>
					</div>
				</div>
	...
	<a href="/front/appt/regist" class="btn btn-outline btn-md" class="login" id="registBtn"
		style="font-size: 16px;display: block;margin-bottom: 4%;margin-left: auto;margin-right: auto;"><spring:message code="wait.msg.regist_appt"/></a>
</section>
