...
public class AppConstBean {
	...
	public static final String APP_COMPONENT_SCAN_PACKAGE = "com.way.you";				// Component Scan Package (=Project Package)
	/*
	 ...
	 */
	public static final String APP_NAME = "WAY YOU";
	 ...
	 * DB - MyBatis Config
	 ************************************************************************** */
	public static final String MYBATIS_CONFIG_PATH = "classpath:com/way/you/config/mybatis-config.xml";
...
//		"/WEB-INF/views_mobile/template/layout/tiles.xml"
		"WEB-INF/views/tiles.xml"
//		"/WEB-INF/views/template/layout/tiles.xml"			//모바일 tiles.xml
//		, "/WEB-INF/views/template/layout/product/tiles.xml"		//PC tiles.xml
	};
