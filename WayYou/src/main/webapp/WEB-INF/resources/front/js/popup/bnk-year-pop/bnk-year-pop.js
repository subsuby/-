...
.directive('yearPop', function ($rootScope, $timeout) {
 ...
 * #################################################################################### */
	...
	var TEMPLATE_ID = 'year-pop';	// 변경 <= 팝업ID(폴더,파일명)
...
//							// transcluded DOM을 template에서 ngTransclude directive에 삽입한다
		 ...
		 * #################################################################################### */
			...
			$scope.guaranteeClick = function(){
				ITCButton.getPopup('.popWrapGuarantee').open();
			}
